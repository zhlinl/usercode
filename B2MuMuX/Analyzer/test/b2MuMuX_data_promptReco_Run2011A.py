...
#		'store/data/Run2011A/MuOnia/AOD/PromptReco-v5/000/170/053/FE0ACE73-40B0-E011-B69A-BCAEC53296F4.root',
		'store/data/Run2011A/MuOnia/AOD/PromptReco-v6/000/175/755/241CF6A4-6CDA-E011-BD2A-003048D373AE.root'
    )
)
...
process.mkcands = cms.EDAnalyzer('Analyzer',
      treeFileName=cms.string("tree_b2MuMuX.root"),
      AnalyzeMC=cms.untracked.bool(False),
      ...
      dimuonSelection  = cms.string("(mass>1.0 && mass<6.0)&&abs(daughter('muonP').innerTrack.dz - daughter('muonM').innerTrack.dz) < 25"), ## The dimuon must pass this selection before vertexing
      TriMuRECO=cms.untracked.bool(False), # Tri-Muon selection not used for Exotica qqbar state selection
		 	OniaTrackRECO=cms.untracked.bool(False), # Onia plus track selection
