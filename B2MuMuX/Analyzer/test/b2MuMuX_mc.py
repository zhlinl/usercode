...
process.source = cms.Source("PoolSource",
		...
		'file:/publicfs/cms/data/Publics/zhangll/data/BdKstarMuMu/reco/Reco_00.root',
		'file:/publicfs/cms/data/Publics/zhangll/data/BdKstarMuMu/reco/Reco_01.root',
		'file:/publicfs/cms/data/Publics/zhangll/data/BdKstarMuMu/reco/Reco_02.root'
    )
)
...
process.mkcands = cms.EDAnalyzer('Analyzer',
      treeFileName=cms.string("tree_b2MuMuX_MC.root"),
