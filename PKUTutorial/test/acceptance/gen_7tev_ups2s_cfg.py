...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs/CMSSW/UserCode/YZheng/UpsilonAna/test/acceptance/gen_7tev_ups2s_cfg.py,v $')
)
...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('/tmp/yzheng/filter2s.root'),
...
process.DT = cms.EDAnalyzer("DimuonTree",
  OutputFile = cms.string("gen_7tev_ups2s_tree.root")
)
