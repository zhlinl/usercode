...
void genXSupsilon2Srap(const char* file = "genUpsilon2S.root", const char* outputName = "genXSupsilon2Srap.root") {
  Float_t pt;
  Float_t y;
  ...
  genY->Sumw2();
  genY->SetTitle(";Upsilon |y|;d#sigma(#Upsilon(2S))xBr(#mu#mu)/dy (nb)");
...
int main(int argc, const char** argv){
  genXSupsilon2Srap(argv[1],argv[2]);
}
