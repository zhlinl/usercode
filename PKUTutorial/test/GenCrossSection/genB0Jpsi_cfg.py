...
process.TFileService = cms.Service("TFileService", fileName = cms.string("genB0Jpsi.root"))
...
process.generation_step = cms.Path(process.generator * process.b0filter * process.pgen * process.tree)
