...
void genXSupsilon1Srap(const char* file = "genUpsilon1S.root", const char* outputName = "genXSupsilon1Srap.root") {
  Float_t pt;
  Float_t y;
  ...
  genY->Sumw2();
  genY->SetTitle(";Upsilon |y|;d#sigma(#Upsilon(1S))xBr(#mu#mu)/dy (nb)");
...
int main(int argc, const char** argv){
  genXSupsilon1Srap(argv[1],argv[2]);
}
