...
#        L1dPhi = cms.string("? userCand('muonL1Info').isNonnull ? userCand('muonL1Info').phi : 9"),
    ...
    flags = cms.PSet(
        ...
        L1MuOpen01 =           cms.string("!triggerObjectMatchesByFilter('hltL1MuOpenL1Filtered0').empty() && userFloat('muonL1Info:deltaR')<0.1"),
        L1MuOpen02 =           cms.string("!triggerObjectMatchesByFilter('hltL1MuOpenL1Filtered0').empty() && userFloat('muonL1Info:deltaR')<0.2"),
        L1MuOpen03 =           cms.string("!triggerObjectMatchesByFilter('hltL1MuOpenL1Filtered0').empty() && userFloat('muonL1Info:deltaR')<0.3"),
        L1MuOpen04 =           cms.string("!triggerObjectMatchesByFilter('hltL1MuOpenL1Filtered0').empty() && userFloat('muonL1Info:deltaR')<0.4"),
        ...
        L1DoubleMuOpen01 = cms.string("!triggerObjectMatchesByFilter('hltDoubleMuLevel1PathL1OpenFiltered').empty() && userFloat('muonL1Info:deltaR')<0.1"),
        L1DoubleMuOpen02 = cms.string("!triggerObjectMatchesByFilter('hltDoubleMuLevel1PathL1OpenFiltered').empty() && userFloat('muonL1Info:deltaR')<0.2"),
        L1DoubleMuOpen03 = cms.string("!triggerObjectMatchesByFilter('hltDoubleMuLevel1PathL1OpenFiltered').empty() && userFloat('muonL1Info:deltaR')<0.3"),
        L1DoubleMuOpen04 = cms.string("!triggerObjectMatchesByFilter('hltDoubleMuLevel1PathL1OpenFiltered').empty() && userFloat('muonL1Info:deltaR')<0.4"),
        L1DoubleMuOpen_Tight = cms.string("!triggerObjectMatchesByFilter('hltL1DoubleMuOpenTightL1Filtered').empty()"),
        L1DoubleMuOpen_Tight01 = cms.string("!triggerObjectMatchesByFilter('hltL1DoubleMuOpenTightL1Filtered').empty() && userFloat('muonL1Info:deltaR')<0.1"),
        L1DoubleMuOpen_Tight02 = cms.string("!triggerObjectMatchesByFilter('hltL1DoubleMuOpenTightL1Filtered').empty() && userFloat('muonL1Info:deltaR')<0.2"),
        L1DoubleMuOpen_Tight03 = cms.string("!triggerObjectMatchesByFilter('hltL1DoubleMuOpenTightL1Filtered').empty() && userFloat('muonL1Info:deltaR')<0.3"),
        L1DoubleMuOpen_Tight04 = cms.string("!triggerObjectMatchesByFilter('hltL1DoubleMuOpenTightL1Filtered').empty() && userFloat('muonL1Info:deltaR')<0.4"),
        L1DoubleMuOpen_OR =    cms.string("!triggerObjectMatchesByFilter('hltDoubleMuLevel1PathL1OpenFiltered').empty() || !triggerObjectMatchesByFilter('hltL1DoubleMuOpenTightL1Filtered').empty()"),
    ...
    tagFlags = cms.PSet(
        ...
        L2Mu0 =                cms.string("!triggerObjectMatchesByFilter('hltL2Mu0L2Filtered0').empty()"),
        Mu3 =                  cms.string("!triggerObjectMatchesByFilter('hltSingleMu3L3Filtered3').empty()"),
        Mu5 =                  cms.string("!triggerObjectMatchesByFilter('hltSingleMu3L3Filtered3').empty()"),
        L1DoubleMuOpen_Tight = cms.string("!triggerObjectMatchesByFilter('hltL1DoubleMuOpenTightL1Filtered').empty()"),
        L1DoubleMuOpen_Tight01 = cms.string("!triggerObjectMatchesByFilter('hltL1DoubleMuOpenTightL1Filtered').empty() && userFloat('muonL1Info:deltaR')<0.1"),
        L1DoubleMuOpen_Tight02 = cms.string("!triggerObjectMatchesByFilter('hltL1DoubleMuOpenTightL1Filtered').empty() && userFloat('muonL1Info:deltaR')<0.2"),
        L1DoubleMuOpen_Tight03 = cms.string("!triggerObjectMatchesByFilter('hltL1DoubleMuOpenTightL1Filtered').empty() && userFloat('muonL1Info:deltaR')<0.3"),
...
def selection(process, GlobalTag="GR_R_38X_V8::All", MC=False, SelectionTrigger="hltL1DoubleMuOpenTightL1Filtered"):
    ...
    # Tag and Probe
    process.nearbyMuonsInfo = cms.EDProducer("NearbyMuonsInfo",
        # put here a collection of Composite Candidates with ShallowClones to muons
        src = tagAndProbe.tagProbePairs, 
